    ...
    try {
      ...
      await scanner.start(
        ...
        (decodedText) => {
          ...
          // Expected format: https://yourdomain.com/verify/[productId]
          ...
          if (match) {
            ...
            // URL format but can't parse - just navigate
            stopScanning()
        ...
        <div className="bg-gray-900 rounded-2xl p-6 shadow-xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className={`relative p-6 rounded-xl border-2 transition ${
              step === 1 ? "border-blue-500 bg-blue-900/20" : "border-gray-700 bg-gray-800"
            }`}>
            ...
            {/* Step 2 */}
            <div className={`relative p-6 rounded-xl border-2 transition ${
              step === 2 ? "border-blue-500 bg-blue-900/20" : "border-gray-700 bg-gray-800"
            }`}>
              <div className="absolute -top-4 left-6 bg-blue-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold">
                2
              </div>
            ...
            {/* Step 3 */}
            <div className={`relative p-6 rounded-xl border-2 transition ${
              step === 3 ? "border-blue-500 bg-blue-900/20" : "border-gray-700 bg-gray-800"
            }`}>
              <div className="absolute -top-4 left-6 bg-blue-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold">
                3
              </div>
